...
- **Project Updated:** `Smallbox` — `[beta tested]` Beta-tested instant SERP rank fluctuation tracker with webhook alerts
- **Project Updated:** `Ongrow` — `[bug]` Resolved widget iframe resizing issue on mobile Safari viewports
